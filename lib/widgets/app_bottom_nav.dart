      ...
      if (event.snapshot.exists) {
        ...
        data.forEach((key, value) {
          ...
          if (participants != null && participants.containsKey(userId)) {
            final unread = conv['unreadCount_$userId'] as int? ?? 0;
            count += unread;
          }
        });
      }
      ...
      child: SafeArea(
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              // Tab 1: Trang chủ
              _buildNavItem(context, 0, Icons.home_rounded, 'Trang chủ', '/dashboard', primary),
              // Tab 2: Sức khỏe
              _buildNavItem(context, 1, Icons.favorite_rounded, 'Sức khỏe', '/health-hub', success),
              // Center: Chat button
              _buildCenterChatButton(context),
              // Tab 3: Bác sĩ
              _buildNavItem(context, 2, Icons.medical_services_rounded, 'Bác sĩ', '/doctor-hub', warning),
              // Tab 4: Cá nhân
              _buildNavItem(context, 3, Icons.person_rounded, 'Cá nhân', '/profile', purple),
            ],
          ),
        ),
      ),
